...
const Bishop = ({primaryColor, secondaryColor}) => {
  ...
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width={`${PIECE_WIDTH}`} height={`${PIECE_HEIGHT}`} viewBox={`0 0 ${PIECE_WIDTH} ${PIECE_HEIGHT}`}>
      <g style={bishopStyle}>
        ...
        <path d="M 17.5,26 L 27.5,26 M 15,30 L 30,30 M 25 16 A 2.5 2.5 0 1 1  20,16 A 2.5 2.5 0 1 1  25 16 z" style={{ fill: 'none', stroke: secondaryColor, strokeLinejoin: 'miter' }} />
      </g>
    </svg>
  );
}
